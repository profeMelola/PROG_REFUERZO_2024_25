...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("********** puntos después de cargar ***********");
        ...
        System.out.println("La edad media de los Simpson es: "+Utilidades.calcularEdadMedia(edades));
        System.out.printf("La edad media de los Simpson es %.2f \n",Utilidades.calcularEdadMedia(edades));

        System.out.println("2.NOMBRE DEL PERSONAJE DE LOS SIMPSON QUE TIENE MÁS PUNTOS:");
        String nombre = Utilidades.obtenerPersonajesMasPuntos(nombres,puntos);
        System.out.println(nombre);

        System.out.println("3.DNIS REPETIDOS"); // PENDIENTE PARA EL LUNES 24 DE MARZO
